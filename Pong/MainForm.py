...
class MainForm(Form):
	...
	def InitializeComponent(self):
		...
		self._pictureBox6.Location = System.Drawing.Point(125, 421)
		...
		self.DoubleClick += self.LblballClick
	...
	def TimerballTick(self, sender, e):
		...
		if ball.Location.X >= self.Width or ball.Location.X > rpdl.Right + 20 and ball.Location.Y > rpdl.Top:
			...
			""" TODO: FINISH RIGHT SCORE WIN CONDITION - done"""
	...
	def LblrightClick(self, sender, e):
		self._lblright.BackColor = Color.DeepPink
